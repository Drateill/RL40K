...
class AudioEngine:
    ...
    def load_real_sounds(self):
        ...
        # 🔧 CORRECTION: Nouveau chemin après restructuration
        # Depuis src/systems/ on remonte de 2 niveaux pour atteindre la racine
...
class SoundManager:
    ...
    def __init__(self):
        ...
        # Ajouter master_volume pour compatibilité avec settings_menu
    ...
    def set_master_volume(self, volume):
        ...
        # Maintenir l'attribut master_volume pour compatibilité
